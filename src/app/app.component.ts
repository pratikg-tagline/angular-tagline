...
interface Backend{
  ...
  javaimg:string,
  javaheading:string,
  golanguageimg:string,
  golanguageheading:string
}
interface Frontend{
  reactimg:string,
  reactheading:string,
  angularimg:string,
  angularheading:string,
  typescriptimg:string,
  typescriptheading:string,
  vuejsimg:string,
  vuejsheading:string,
  mateotjsimg:string,
  mateotjsheading:string,
  javascriptimg:string,
  javascriptheading:string
  htmlimg:string,
  htmlheading:string
}
interface Whytegline{
  teglinetitle:string,
  teglinedescription:string,
  progressiveimg:string,
  progressivetitle:string,
  progressiveheading:string,
  progressivedescription:string,
  projectmanagementimg:string,
  projectmanagementtitle:string,
  projectmanagementheading:string,
  projectmanagementdescription:string,
  engagementmodelimg:string,
  engagementmodeltitle:string,
  engagementmodelheading:string,
  engagementmodeldescription:string,
  costeffectiveimg:string,
  costeffectivetitle:string,
  costeffectiveheading:string,
  costeffectivedescription:string,
  consistentdeliveryimg:string,
  consistentdeliverytitle:string,
  consistentdeliveryheading:string,
  consistentdeliverydescription:string,
  empower:string,
  your:string,
  business:string,
  withdedicateddevelopers:string,
  button:string
}
interface Clientele{
  ...
  clienteleheading1:string,
  clienteledesc1:string,
  clienteledes1:string,
  clientelereview1:string,
  clienteleheading2:string,
  clienteledesc2:string,
  clienteledes2:string,
  clientelereview2:string,
  clienteleheading3:string,
  clienteledesc3:string,
  clienteledes3:string,
  clientelereview3:string,
  clienteleheading4:string,
  clienteledesc4:string,
  clienteledes4:string,
  clientelereview4:string,
  clienteleheading5:string,
  clienteledesc5:string,
  clienteledes5:string,
  clientelereview5:string,
  clienteleheading6:string,
  clienteledesc6:string,
  clienteledes6:string,
  clientelereview6:string,
}
interface Awards{
  awardstitle1:string,
  awardstitle2:string,
...
export class AppComponent {
  ...
  firstp:string='With the help of Innovation and Technology, We give you the power to <br> change the world with yourideas.'
  ...
  Amd:Amd={
  madimg:"../assets/../assets/images/web-design-icon.webp",
  madtitle:'Software Product Engineering',
  maddescription:'We are dedicated to providing the best Software product engineering services for your business. Ourteam of developers provides the service of software product engineering and it includes designing,developing, testing, and deploying the software products',
  learnmore:'Learn More ->',
  }
  agiledevops:Agiledevops={
    agiledevopsimg:"../assets/../assets/images/web-design-icon.webp",
    agiledevopstitle:'Agile QA, Automation, and DevOps',
    agiledevopsdescription:'At Tagline Infotech, we have a team of dedicated developers that provide the services like Agile QA,Automation, and DevOps. Our DevOps engineers constantly do the testing of software while Agile QAensures the quality of the software',
    learnmore:'Learn More ->',
  }
  digitaldesign:Digitaldesign={
    digitaldesignimg:"../assets/../assets/images/uiux-design-icon.webp",
    digitaldesigntitle:'Digital Strategy & Design',
    digitaldesigndescription:'Tagline Infotech helps clients to create a clear digital strategy and design for the growth of theirbusinesses. Our developers and UI UX designers put the user first to create easy-to-navigate interfaces and smooth end-to-end experiences',
    learnmore:'Learn More ->'
  }
  softwarecompany:Softwarecompany={
    softwarwcompanyimg:"../assets/../assets/images/software-development-1.png",
    softwarwcompanytitle:'Software outsourcing company',
    softwarwcompanydescription:'Tagline Infotech is an experienced software outsourcing company that provides services for variousbusinesses. We have a reliable team of developers that provides high-quality outsourcing services to scale your business.',
    learnmore:'Learn More ->'
  }
  ...
  professional:Professional={
    ...
    professionalproject:'125+',
    professionaltital:'Professional',
    
    professionalimg:"../assets/../assets/images/contentlogo.webp",
  }
  completedproject:Completedproject={
 
    completedprojectproject:'450+',
    completedprojecttital:"Completedproject",
    
    completedprojectimg:"../assets/../assets/images/contentlogo2.webp",
  }
  freelancehours:Freelancehours={
 
    freelancehoursproject:'150+',
    freelancehourstital:'Freelancehours',
    
    freelancehoursimg:"../assets/../assets/images/contentlogo3.webp",
  }
  yearsofexperience:Yearsofexperience={
   
    yearsofexperienceproject:'+5',
    yearsofexperiencetital:'Yearsofexperience',
    
    yearsofexperienceimg:"../assets/../assets/images/contentlogo4.webp",
  }
  ...
  whytegline: Whytegline={
    ...
    progressiveimg:'../assets/../assets/images/choose-roadmap.png',
  progressivetitle:'Progressive Roadmap',
  progressiveheading:'01',
  progressivedescription:'Our team of developers creates a progressive roadmap that includes a strategic plan to define a goal andmajor steps to reach that goal. We have a team of developers that uses progressive',
  projectmanagementimg:'../assets/../assets/images/choose-project.png',
  projectmanagementtitle:'Efficient Project Management',
  projectmanagementheading:'02',
  projectmanagementdescription:'We believe in efficient project management and our experienced developers use project management tools like Wrike and Zoho. Our developers use these project management tools efficiently',
  engagementmodelimg:'../assets/../assets/images/choose-flexible.svg',
  engagementmodeltitle:'Flexible Engagement Model',
  engagementmodelheading:'03',
  engagementmodeldescription:'We provide flexible engagement models so that clients can hire developers for their projects. Theseengagement models are flexible so if you aren’t satisfied with any model you can switch to another.',
  costeffectiveimg:'../assets/images/choose-cost.png',
  costeffectivetitle:'Cost-Effective',
  costeffectiveheading:'04',
  costeffectivedescription:'Our team of developers provides the best development services at affordable prices. We believe thathigh-quality solutions can be delivered at cost-effective prices and that’s why we provide different hiring',
  consistentdeliveryimg:'../assets/images/choose-delivery.png',
  consistentdeliverytitle:'Consistent Delivery',
  consistentdeliveryheading:'05',
  consistentdeliverydescription:'Our developers follow an agile approach to deliver the project before the deadline. We are providingconsistent delivery of fully-featured projects as per the client’s requirements.',
  empower:'Empower',
  your:'Your ',
  business:'Business',
  ...
  clientele: Clientele={
    ...
    clienteledescription1:'Good things come for those who work hard, and thats why our clientele appreciate our efforts. Tagline Infotech provides the best services to its clients, and it is reflected through our ratings and reviewson various platforms.',
    clienteledescription2:'We are a well-known IT services company on Clutch. Check out what our customers have to say about ourservices. Read their ratings, feedback, and stories about partnering with us before making your own decision.',
  ...
  clienteledesc2:'They understand complex technical requirements, and they have a team that quickly gets up to speed.',
  clienteledes2:'Founder, Cimpro.io',
  clientelereview2:'Verified Review',
  clienteleheading3:'5.0',
  clienteledesc3:'…theyre able to tackle pretty much everything you throw at them.',
  clienteledes3:'CEO, Promoprep',
  clientelereview3:'Verified Review',
  clienteleheading4:'5.0',
  clienteledesc4:'When things go wrong, they were good at adapting and problem solving on the fly.',
  clienteledes4:'CEO, SupplementSnoop',
  clientelereview4:'Verified Review',
  clienteleheading5:'5.0',
  clienteledesc5:'The team takes up new challenges and finishes the project on time.',
  clienteledes5:'Software Architect, Specialty Finance Company',
  clientelereview5:'Verified Review',
  clienteleheading6:'5.0',
  clienteledesc6:'We are getting close to launch now and its been a tremendous help to have their developers on my team.',
  ...
  ourblogs :Ourblogs={
    ...
    pythondescription:'Quick Summary The most difficult decision for an entrepreneur is deciding on a programming...',
    ...
    nodejsdescription:'Quick Summary Want to know about node js architecture and node js architecture best',
    nodejsread:'Read More ->',
    rorimg:'../assets/images/Kotlin-vs-Java.png',
    rorbtn:'RoR',
    rordate:'9/12/22',
    rortitle:'JavaScript vs Ruby On Rails: What...',
    rordescription:'Quick Summary: Ruby on Rails and JavaScript both languages are both widely popular among',
    rorread:'Read More ->',
  
  }
  globalpresence:Globalpresence={
    firstheading:'India (HQ)',
    firstdescription:'Digital Valley, 423, Apple Square, beside Lajamni Chowk, Mota Varachha, Surat,Gujarat 394101',
